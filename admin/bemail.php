...
<div class="row">
  ...
  <select class="browser-default hoverable" id="options">
    ...
    <option value="mboard.php">Check Send SMS</option>
		<option value="bemail.php">Check Send Email</option>
  </select>
  </div>
</div>
...
<div class="card">
 ...
 <div class="card-body">
 <table class="responsive-table centered bordered" id="emails">
    <thead>
      <tr>
        <th>#</th>
        <th>subject</th>
    ...
    <tbody>
      <tr>
        <?php
        require 'connect.php';
        $query = $connection->query("SELECT * FROM bemail");
